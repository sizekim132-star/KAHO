      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div className="reveal-card recruit-card" style={{
            ...
            <video className="recruit-card-video" autoPlay loop muted playsInline>
              <source src="https://raw.githubusercontent.com/sizekim132-star/kaho-assets/main/backforest.mp4" type="video/mp4" />
            </video>
            <div className="recruit-card-video-overlay" />
          ...
          <div className="reveal-card recruit-card" style={{
            ...
            <video className="recruit-card-video" autoPlay loop muted playsInline>
              <source src="https://raw.githubusercontent.com/sizekim132-star/kaho-assets/main/join.mp4" type="video/mp4" />
            </video>
            <div className="recruit-card-video-overlay" />
